...
pipeline {
    ...
    parameters {
        ...
        string(defaultValue: "${env.backupPath}", description: 'Путь к папке для бекапа', name: 'backupPath')
    }
                ...
                timestamps {
                    script {
                        ...
                        for (i = 0;  i < templatebasesList.size(); i++) {
                            ...
                            backupPath = "${env.backupPath}/temp_${templateDb}_${utils.currentDateStamp()}.bak"
